...
<div class="row">
	<div class="col-md-6 mb-3">
		<a href="{{ route('admin.kategori.add') }}" class="btn btn-dark bg-info">[+] Tambah</a>
	</div>
		...
		<form method="GET" action="{{ route('admin.kategori') }}">
			<div class="input-group">
				...
				<div class="input-group-append">
					<button type="submit" class="btn btn-dark bg-info">
						Cari!
					</button>
				</div>
			</div><!-- end input group -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-dark bg-info btn-delete" type="button">Delete</button>
			</div>
